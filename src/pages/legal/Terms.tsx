  ...
  return (
    ...
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-manrope text-[#15181A] dark:text-white mb-2">Terms of Service</h1>
        <p className="text-gray-700 text-sm font-inter dark:text-gray-400 mb-8">Last updated: October 1, 2025</p>

        <div className="space-y-6 text-[#15181A] dark:text-white">
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">1. Acceptance of Terms</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">2. Use License</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans mb-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-400 ml-4 font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">3. Disclaimer</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">4. Limitations</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">5. Accuracy of Materials</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">6. Links</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">7. Modifications</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">8. Governing Law</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-3 text-[#15181A] dark:text-white font-manrope">9. Contact Information</h2>
            <p className="text-gray-700 dark:text-gray-400 leading-relaxed font-opensans">
        ...
        <div className="mt-10 pt-6 border-t border-gray-300 dark:border-gray-600">
          <p className="text-sm text-gray-700 dark:text-gray-400 text-center font-opensans">
