...
export default function Terms () {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      {/* Agreement Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">AGREEMENT TO OUR LEGAL TERMS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          We are <strong>KorvLabs</strong> ('<strong>Company</strong>', '<strong>we</strong>', '<strong>us</strong>', or '<strong>our</strong>'), 
          a company registered in Kenya at Kilimani Rd, Nairobi City, Nairobi City, Nairobi County 20100.
        </p>
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          Korvbox allows users to supply stablecoins into Morpho Protocol, where they can earn yield by providing 
          liquidity to verified borrowers. The process is fully transparent and on Base mainnet.
        </p>

        <p className="mb-4 text-gray-700 leading-relaxed">
          You can contact us by phone at 254113509132, email at{' '}
          <a href="mailto:contact@korvlabs.io" className="text-blue-600 hover:underline">
            contact@korvlabs.io
          </a>
          , or by mail to Kilimani Rd, Nairobi City, Nairobi City, Nairobi County 20100, Kenya.
        </p>

        <p className="mb-4 text-gray-700 leading-relaxed">
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf 
          of an entity ('<strong>you</strong>'), and KorvLabs, concerning your access to and use of the Services. 
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          <a href="mailto:updates@korvlabs.io" className="text-blue-600 hover:underline">
            updates@korvlabs.io
          </a>
          , as stated in the email message. By continuing to use the Services after the effective date of any changes, 
      ...
      <div className="mb-8">
        ...
        <ol className="list-decimal list-inside space-y-2 text-blue-600">
          ...
          <li><a href="#license" className="hover:underline">CONTRIBUTION LICENCE</a></li>
          <li><a href="#sitemanage" className="hover:underline">SERVICES MANAGEMENT</a></li>
          <li><a href="#ppyes" className="hover:underline">PRIVACY POLICY</a></li>
      ...
      <section id="services" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">1. OUR SERVICES</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="ip" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        
        <h3 className="text-xl font-bold mb-3 text-gray-700">Our intellectual property</h3>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <h3 className="text-xl font-bold mb-3 mt-6 text-gray-700">Your use of our Services</h3>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <h3 className="text-xl font-bold mb-3 mt-6 text-gray-700">Your submissions</h3>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation 
          to you.
        </p>
        ...
        <ul className="list-disc list-inside mb-4 ml-4 text-gray-700 space-y-2">
          ...
          <li>warrant that any such Submission are original to you or that you have the necessary rights and licences 
      ...
      <section id="userreps" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">3. USER REPRESENTATIONS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          By using the Services, you represent and warrant that: (1) you have the legal capacity and you agree to 
          comply with these Legal Terms; (2) you are not under the age of 13; (3) you are not a minor in the 
      ...
      <section id="purchases" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">4. PURCHASES AND PAYMENT</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          time. All payments shall be in USDC.
        </p>
        <p className="mb-4 text-gray-700 leading-relaxed">
          You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping fees, 
          and you authorise us to charge your chosen payment provider for any such amounts upon placing your order. We 
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          shipping address. We reserve the right to limit or prohibit orders that, in our sole judgement, appear to be 
      ...
      <section id="prohibited" className="mb-8">
        ...
        <ul className="list-disc list-inside mb-4 ml-4 text-gray-700 space-y-2">
          ...
          <li>Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or distribute 
            ...
            accesses the Services, or use or launch any unauthorised script or other software.</li>
          <li>Use a buying agent or purchasing agent to make purchases on the Services.</li>
          <li>Make any unauthorised use of the Services, including collecting usernames and/or email addresses of users by electronic 
      ...
      <section id="ugc" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">6. USER GENERATED CONTRIBUTIONS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <ul className="list-disc list-inside mb-4 ml-4 text-gray-700 space-y-2">
          ...
          <li>You are the creator and owner of or have the necessary licences, rights, consents, releases, and permissions to 
            use and to authorise us, the Services, and other users of the Services to use your Contributions in any manner 
          ...
          <li>Your Contributions are not unsolicited or unauthorised advertising, promotional materials, pyramid schemes, chain 
            letters, spam, mass mailings, or other forms of solicitation.</li>
      ...
      {/* Section 7: Contribution Licence */}
      <section id="license" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">7. CONTRIBUTION LICENCE</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      {/* Section 8: Services Management */}
      <section id="sitemanage" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">8. SERVICES MANAGEMENT</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="ppyes" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">9. PRIVACY POLICY</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="terms" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">10. TERM AND TERMINATION</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="modifications" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">11. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="law" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">12. GOVERNING LAW</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          These Legal Terms shall be governed by and defined following the laws of Kenya. KorvLabs and yourself irrevocably 
          consent that the courts of Kenya shall have exclusive jurisdiction to resolve any dispute which may arise in 
      ...
      <section id="disputes" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">13. DISPUTE RESOLUTION</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="corrections" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">14. CORRECTIONS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="disclaimer" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">15. DISCLAIMER</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES 
          AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND 
          MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE 
          OF THE SERVICES, (3) ANY UNAUTHORISED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION 
          ...
          PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED 
      ...
      <section id="liability" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">16. LIMITATIONS OF LIABILITY</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="indemnification" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">17. INDEMNIFICATION</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          exclusive defence and control of any matter for which you are required to indemnify us, and you agree to cooperate, 
          at your expense, with our defence of such claims. We will use reasonable efforts to notify you of any such claim, 
      ...
      <section id="userdata" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">18. USER DATA</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="electronic" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">19. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="misc" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">20. MISCELLANEOUS</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          ...
          or provision of these Legal Terms shall not operate as a waiver of such right or provision. These Legal Terms operate 
          to the fullest extent permissible by law. We may assign any or all of our rights and obligations to others at any 
          time. We shall not be responsible or liable for any loss, damage, delay, or failure to act caused by any cause beyond 
          our reasonable control. If any provision or part of a provision of these Legal Terms is determined to be unlawful, 
          void, or unenforceable, that provision or part of the provision is deemed severable from these Legal Terms and does 
          ...
          You agree that these Legal Terms will not be construed against us by virtue of having drafted them. You hereby waive 
          any and all defences you may have based on the electronic form of these Legal Terms and the lack of signing by the 
      ...
      <section id="contact" className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">21. CONTACT US</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
        ...
        <div className="mb-4 text-gray-700 leading-relaxed">
          ...
          <p>Kilimani Rd, Nairobi City</p>
          <p>Nairobi City, Nairobi County 20100</p>
          <p>Kenya</p>
          <p>Phone: 254113509132</p>
          <p>
            <a href="mailto:contact@korvlabs.io" className="text-blue-600 hover:underline">
              contact@korvlabs.io
            </a>
